...
import com.weapplinse.anandi.training_app.R
...
class NativeAdFactory(val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val nativeAdView = LayoutInflater.from(context)
            .inflate(R.layout.native_video_ad, null) as NativeAdView
...
//                attributionViewLarge.visibility = View.VISIBLE
            ...
            val mediaView = findViewById<com.google.android.gms.ads.nativead.MediaView>(R.id.native_ad_media)
