...
class OnAudioQueryScreen extends StatefulWidget {
  final String title;
  OnAudioQueryScreen({Key? key, required this.title}) : super(key: key);

  @override
  State<OnAudioQueryScreen> createState() => _OnAudioQueryScreenState();
}

class _OnAudioQueryScreenState extends State<OnAudioQueryScreen> {
  // bg color
